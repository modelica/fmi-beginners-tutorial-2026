...
typedef struct IDAMemRec {
  ...
  /*----------------
     DS Extensions
    ----------------*/
  IDAStepRootFn ida_stepgfun;
  IDAMonitorFN ida_monitorfun;     /* Mimicing CVode monitor function  */
  IDAAtDAEEvent ida_atdaeeventfun;
  int ida_accurate_dae_crossing;
  realtype ida_next_time_event;
  IDAStateErrorMonitorFN ida_stateerrormonitorfun;
