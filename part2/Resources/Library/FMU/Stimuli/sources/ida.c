...
static int IDANls(IDAMem IDA_mem)
{
  ...
  if (IDA_mem->ida_stateerrormonitorfun) {
      for (i = 0; i < nnf_inc; ++i)
          (*IDA_mem->ida_stateerrormonitorfun)(IDA_mem->ida_tn - IDA_mem->ida_hh, IDA_mem->ida_hh, IDA_mem->ida_kk, 2, 0, NULL, NULL, 0.0, 0.0);
  }
                        ...
                        realtype *err_k, realtype *err_km1)
{
  ...
  *err_k = IDA_mem->ida_sigma[IDA_mem->ida_kk] * enorm_k;
  ...
  if (IDA_mem->ida_stateerrormonitorfun)
      (*IDA_mem->ida_stateerrormonitorfun)(IDA_mem->ida_tn - IDA_mem->ida_hh, IDA_mem->ida_hh, IDA_mem->ida_kk, ck * enorm_k > ONE, N_VGetLength(IDA_mem->ida_ewt),
