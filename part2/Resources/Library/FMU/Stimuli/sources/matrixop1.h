...
#define DYN_NORETURN_ATTR __attribute((noreturn))
...
/* End of common routines for String*/
static DYN_UNUSED_ATTR IntegerArray identity(Integer n) {return IntegerIdentity(n);}
static DYN_UNUSED_ATTR Integer real2integer(Real x) {return (Integer)(floor(x));}
