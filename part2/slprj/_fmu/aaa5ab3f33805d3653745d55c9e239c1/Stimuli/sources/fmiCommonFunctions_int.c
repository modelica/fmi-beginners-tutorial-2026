...
static DYM_INLINE FMIBoolean setIsAllowed(Component* comp, FMICategory cat);
...
//extern DYMOLA_STATIC void GetStringDymArrayValues(struct DYNInstanceData* did_, int index, const char** data, int nbrData);
