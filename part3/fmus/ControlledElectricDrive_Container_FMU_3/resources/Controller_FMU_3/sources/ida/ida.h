...
DS extensions
-----------------------*/
typedef int (*IDAStepRootFn)(void*user_data);
typedef int (*IDAMonitorFN)(void *IDA_mem, void *user_data);
typedef int (*IDAAtDAEEvent)(void* user_data, int accurateCrossing);
typedef void (*IDAStateErrorMonitorFN)(void* user_data, realtype time, realtype h, int q, int rejected,
