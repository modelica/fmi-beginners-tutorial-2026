...
*/
DYMOLA_STATIC LIBDS_API_AFTER double delayFunction3(delayStruct* del, int idd, double delaytime, double maxDelayTime, double t, double u, const char* exprStr,
    int Event,  double* rel, double* qp, double* qn, int* qen, double* qz2, int* AnyEvent, int* AnyDEvent);
...
DYMOLA_STATIC LIBDS_API_AFTER double delayDCFunction3(delayStruct * del, double expr, double dt, int *isAllocated, int delayId, int BufferSize, double Time, int Event,
	double*rel, double*qp, double*qn, int*qen, double*qz2, int*AnyEvent, int *AnyDEvent);
...
#endif
DYMOLA_STATIC LIBDS_API_AFTER void transportPut3(delayStruct* del, double T1pre, double T1, double T2pre, double T2, double x, int vs, int id, int ev);
DYMOLA_STATIC LIBDS_API_AFTER void transportGet3(delayStruct* del, double T1, double T2, double x, int vs, int id, double* Tf1, double* Tf2, int ev);
