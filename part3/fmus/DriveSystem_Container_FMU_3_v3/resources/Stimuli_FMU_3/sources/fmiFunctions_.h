...
#if !defined FMI3_FUNCTION_PREFIX && defined MODEL_IDENTIFIER
#define _paste(a,b) a ## b
#define _pasteB(a,b) _paste(a,b)
#define FMI3_FUNCTION_PREFIX _pasteB(MODEL_IDENTIFIER,_)
#endif
...
#if (FMI_VERSION < FMI_2) && !defined(FMU_CO_SIM)
...
#endif
#endif /* !(FMI_VERSION >= FMI_2) && !defined(FMU_CO_SIM) */
