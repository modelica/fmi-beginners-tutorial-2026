...
LIBDS_API int DymosimSetRealDynamicArray(struct DymosimSimulator* dymosimData, const unsigned int vr, const double values[], const int nbrVals);

LIBDS_API int DymosimSetIntegerDynamicArray(struct DymosimSimulator* dymosimData, const unsigned int vr, const int values[], const int nbrVals);

LIBDS_API int DymosimGetRealDynamicArray(struct DymosimSimulator* dymosimData, const unsigned int vr, double values[], const int nbrVals);

LIBDS_API int DymosimGetIntegerDynamicArray(struct DymosimSimulator* dymosimData, const unsigned int vr, int values[], const int nbrVals);

LIBDS_API int DymosimEnterConfigurationMode(struct DymosimSimulator* instance);

LIBDS_API int DymosimExitConfigurationMode(struct DymosimSimulator* instance);
